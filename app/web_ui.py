# ✅ EcoFriend AI — Final UI Update with Avatars and Mac GPU Support
...
@st.cache_resource
def setup():
    return load_model_and_index("app/docs", device=device)
...
if user_input:
    ...
    response_en = chat_with_ecofriend(processed_input, level, llm, embedder, index, doc_chunks, device)
